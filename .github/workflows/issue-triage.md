...
-->
If the user opens an issue and reports a bug, ensure that enough information 
is present for the maintainer to act upon. At minimum, the reporter should supply 
OS type and version, hardware platfrom, browser type and version, concrete 
steps to reporoduce the bug and the application anme and version they were using. If
this is a GUI application, ask them to supply screenshots of the bug if possible.
